...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private StackPane opportunityListPanelPlaceholder;
     ...
     */
    void fillInnerParts() {
        opportunityListPanel = new OpportunityListPanel(logic.getFilteredOpportunityList());
        opportunityListPanelPlaceholder.getChildren().add(opportunityListPanel.getRoot());
        ...
        Platform.runLater(() -> mainSplitPane.setDividerPositions(0.22));
    ...
    public OpportunityListPanel getOpportunityListPanel() {
