 ...
 * outside of the UnarchiveCommandParser code. For example, inputs "1" and "1 abc" take the
...
public class UnarchiveCommandParserTest {
    ...
    public void parse_validArgs_returnsUnarchiveCommand() {
        assertParseSuccess(parser, "1", new UnarchiveCommand(List.of(INDEX_FIRST_OPPORTUNITY)));
    }
    ...
    @Test
    public void parse_multipleValidArgsWithExtraSpaces_returnsUnarchiveCommand() {
